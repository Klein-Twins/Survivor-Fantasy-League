import { validateSignupRequestData, validateLoginRequestData, isValidName, validateEmail } from "../../../src/servicesAndHelpers/auth/authHelper";
...
describe('validateLoginRequestData', () => {
    it('should throw an error if email is missing', () => {
      ...
      expect(() => validateLoginRequestData(loginData))
        .toThrow();
    ...
    it('should throw an error if password is missing', () => {
      ...
      expect(() => validateLoginRequestData(loginData))
        .toThrow();  // This should throw a 'Missing password' error
...
describe("validateSignupRequestData", () => {
    ...
    test("throws error if email is empty", () => {
        expect(() => validateSignupRequestData({ ...validSignupData, email: "" }))
            .toThrow();
    ...
    test("throws error if email is not in the request", () => {
        ...
        expect(() => validateSignupRequestData(dataWithoutEmail as SignupFields))
            .toThrow();
        expect(errorFactory).toHaveBeenCalledWith({ message: "Missing email", statusCode: 400 });
    });

    test("throws error if email is invalid", () => {
        expect(() => validateSignupRequestData({ ...validSignupData, email: "invalid-email" }))
            .toThrow();
    ...
    test("throws error if password is empty", () => {
        expect(() => validateSignupRequestData({ ...validSignupData, password: "" }))
            .toThrow();
    ...
    test("throws error if password is not in the request", () => {
        ...
        expect(() => validateSignupRequestData(dataWithoutPassword as SignupFields))
            .toThrow();
        expect(errorFactory).toHaveBeenCalledWith({ message: "Missing password", statusCode: 400 });
    });
    ...
    test("throws error if username is empty", () => {
        expect(() => validateSignupRequestData({ ...validSignupData, username: "" }))
            .toThrow();
    ...
    test("throws error if username is not in the request", () => {
        ...
        expect(() => validateSignupRequestData(dataWithoutUsername as SignupFields))
            .toThrow();
        expect(errorFactory).toHaveBeenCalledWith({ message: "Missing username", statusCode: 400 });
    });
    ...
    test("throws error if firstName contains invalid characters", () => {
        expect(() => validateSignupRequestData({ ...validSignupData, firstName: "John123" }))
            .toThrow()
        expect(errorFactory).toHaveBeenCalledWith({ message: "Invalid first name: only letters and spaces allowed", statusCode: 400 });
    });
    ...
    test("throws error if lastName contains invalid characters", () => {
        expect(() => validateSignupRequestData({ ...validSignupData, lastName: "Doe123" }))
            .toThrow();
        expect(errorFactory).toHaveBeenCalledWith({ message: "Invalid last name: only letters and spaces allowed", statusCode: 400 });
    });
