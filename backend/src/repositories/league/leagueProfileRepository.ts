...
async function respondToLeagueInvite(leagueId: string, profileId: string, respondStatus: RespondLeagueInvite, transaction?: Transaction): Promise<LeagueProfileAttributes | null> {
