...
export const season47EpisodeIds: Record<EpisodeKeys, EpisodeAttributes['id']> =
  {
...
interface Season47EpisodeChallengeMap {
  episode1: { immunity1: UUID; reward1: UUID; reward2: UUID };
  ...
  episode12: { immunity1: UUID; immunity2: UUID };
  episode13: { immunity1: UUID; reward1: UUID; immunity2: UUID };
  episode14: { immunity1: UUID };
}

export const season47ChallengeIds: Season47EpisodeChallengeMap = {
  episode1: {
    reward1: '09114b63-7941-40b7-85ee-db89bf8438cf',
    reward2: 'f4a2c0b9-9f3e-4d1d-8b5e-6a5c8f3d7d5f',
  ...
  episode12: {
    immunity2: 'fa8e51f6-4118-485c-8b04-8e970d55e3fd',
