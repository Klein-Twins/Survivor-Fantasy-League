...
import { GetSurvivorsResponseData } from './get-survivors-response-data';
 /**
 * 
 *
 * @export
 * @interface GetSurvivorsResponse
 */
export interface GetSurvivorsResponse extends ApiResponse {
