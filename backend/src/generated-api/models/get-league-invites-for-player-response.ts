...
import { GetLeagueInvitesForPlayerResponseData } from './get-league-invites-for-player-response-data';
 /**
 * 
 *
 * @export
 * @interface GetLeagueInvitesForPlayerResponse
 */
export interface GetLeagueInvitesForPlayerResponse extends ApiResponse {
