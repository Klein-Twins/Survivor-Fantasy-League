...
export const ProfileServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} leagueId The ID of the league the profile is associated with.
         ...
         * @param {number} [limit] The number of profiles to return per page.
         * @param {string} [sortBy] The field to sort the profiles by. Options are \&quot;firstName\&quot;, \&quot;lastName\&quot;, and \&quot;userName\&quot;. Defaults to \&quot;firstName\&quot; if not provided.
         * @param {boolean} [isAsc] A boolean indicating whether to sort in ascending (true) or descending (false) order. Defaults to true (ascending).
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        searchProfilesForLeagueInvite: async (leagueId: string, userName?: string, firstName?: string, lastName?: string, page?: number, limit?: number, sortBy?: string, isAsc?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ProfileServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async searchProfilesForLeagueInvite(leagueId: string, userName?: string, firstName?: string, lastName?: string, page?: number, limit?: number, sortBy?: string, isAsc?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<SearchProfilesForLeagueInviteResponse>>> {
...
export const ProfileServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async searchProfilesForLeagueInvite(leagueId: string, userName?: string, firstName?: string, lastName?: string, page?: number, limit?: number, sortBy?: string, isAsc?: boolean, options?: AxiosRequestConfig): Promise<AxiosResponse<SearchProfilesForLeagueInviteResponse>> {
...
export class ProfileServiceApi extends BaseAPI {
     ...
     */
    public async searchProfilesForLeagueInvite(leagueId: string, userName?: string, firstName?: string, lastName?: string, page?: number, limit?: number, sortBy?: string, isAsc?: boolean, options?: AxiosRequestConfig) : Promise<AxiosResponse<SearchProfilesForLeagueInviteResponse>> {
